...
import img1 from "../assets/projects/heroImg.png";
import {
    Link as ScrollLink,
    Button,
    Element,
                ...
                <div className="grid grid-cols-1 sm:grid-cols-12 place-items-center">
                    ...
                    >
                        <h1 className="text-white mb-4 text-4xl sm:text-4xl md:text-5xl lg:text-6xl font-[700] lg:leading-normal">
                            Hi, I&apos;m{" "}
                            <span className="text-heading">Himanshu</span> a{" "}
                        ...
                        <div className="flex items-center gap-4 flex-col sm:flex-row ">
                            ...
                            <a
                                href="https://drive.google.com/file/d/1z3B28fvkwMOeOqqWtdPb9v8VP7YnDaHM/view?usp=drive_link"
                                target="_blank"
