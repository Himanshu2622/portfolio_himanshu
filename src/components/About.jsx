...
import img2 from "../assets/projects/about.png";
    ...
    return (
        <section className=" sm:px-8 py-[80px] overflow-hidden" id="about">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-12 gap-6 py-6 place-items-center">
                ...
                >
                    <img src={img2} alt="meme" loading="lazy" />
                </motion.div>
                <motion.div
                    ref={refContent}
                ...
                >
                    <p className="text-textWhite p-4 text-lg sm:text-xl sm:leading-8">
                        I am a Web Developer and Problem Solver with a passion for competitive 
                        programming. I love transforming ideas into real projects, focusing on 
                        effective problem-solving to create meaningful solutions.
                        <br />
                        I have experience working with C++, JavaScript, JAVA, HTML,
                        CSS, React.js, Node.js, Express.js, Matlab, Tailwind
                        CSS, and Git.
                        <br />I am a quick learner, a dedicated team player and I am always 
