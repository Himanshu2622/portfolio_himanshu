    ...
    return (
        <nav className="fixed top-0 left-0 w-full z-20 bg-bgDark">
            ...
            >
                ...
                >
                    {/* for mobile view */}
                    <span className="sm:hidden">@Himanshu</span>
                    {/* for web view */}
                    <span className="hidden sm:block">@Himanshu_Srivastava</span>
                </ScrollLink>
                        ...
                        >
                            <div className="flex flex-col md:hidden bg-bgDark relative p-10">
                                ...
                                <div className="flex gap-4 p-6 border-b-white border-b-2 text-[22px]">
                                    <a
                                        href="https://www.linkedin.com/in/himanshu-srivastava1/"
                                        target="_blank"
                                    ...
                                    <a
                                        href="https://github.com/Himanshu2622"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                    >
                                        <BsGithub />
                                    </a>
                                    <a href="mailto:himanshusri2622@gmail.com">
                                        <HiMailOpen />
                                    </a>
                                </div>
